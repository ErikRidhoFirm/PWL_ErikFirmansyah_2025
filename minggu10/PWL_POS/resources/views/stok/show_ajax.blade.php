            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <<input type="datetime-local" name="stok_tanggal" id="stok_tanggal" class="form-control" disabled
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="stok_jumlah" id="stok_jumlah" class="form-control" disabled min="1"
