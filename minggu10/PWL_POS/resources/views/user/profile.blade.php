    ...
    <div class="card card-primary">
      ...
      <div class="card-body">
        <div class="text-center mb-3">
          <img src="{{ $user->profile_photo ? asset('../storage/app/public/' . $user->profile_photo) : asset('adminlte/dist/img/user2-160x160.jpg') }}"
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#btnEditProfile').click(function(){
            modalAction("{{ url('profile_ajax') }}"); // Panggil modalAction dengan URL AJAX
        });
    });
</script>
@endpush